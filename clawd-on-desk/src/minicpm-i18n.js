...
(function initMinicpmI18n(root) {
  ...
  const EN_STRINGS = {
    ...
    onboardingWindowTitle: "Open Desk Pet — First Launch",
    onboardingStepWelcome: "Welcome",
    onboardingStepReady: "Ready",
    // Step 1: welcome
    onboardingEnvWelcome: "Welcome to Open Desk Pet",
    onboardingApiConfigHint: "Open Desk Pet uses remote OpenAI-compatible APIs. After setup, configure your API settings in Settings → Open Desk Pet.",
    onboardingNext: "Next",
    // Step 2: ready
    ...
    // API Mode settings
    minicpmApiMode: "API Mode",
    minicpmApiModeLocal: "Local (llama.cpp)",
    minicpmApiModeRemote: "Remote (OpenAI API)",
    minicpmApiBaseUrl: "API Base URL",
    minicpmApiBaseUrlPlaceholder: "https://api.openai.com/v1",
    minicpmApiKey: "API Key",
    minicpmApiKeyPlaceholder: "sk-...",
    minicpmApiModel: "Model Name",
    minicpmApiModelPlaceholder: "gpt-4o-mini",
    minicpmApiTestConnection: "Test Connection",
    minicpmApiTestSuccess: "Connection successful!",
    minicpmApiTestFailed: "Connection failed: {error}",
    minicpmApiConfigRequired: "Please configure API Base URL and Model Name",
    minicpmRemoteModeNote: "Using remote API: {model}",
    minicpmLocalModeNote: "Using local llama.cpp",
    // Section titles
    minicpmSectionApi: "API Configuration",
    minicpmSectionBehavior: "Behavior",
    minicpmSectionAdvanced: "Advanced",
    // Row labels
    minicpmRowLogs: "Logs",
    minicpmOpenLogs: "Open Logs",
    minicpmRowNarration: "Narration",
    minicpmRowNarrationHint: "Pet comments on AI activity",
    minicpmRowThinking: "Default Thinking",
    minicpmRowThinkingHint: "Enable thinking mode by default",
  };
  const EN_PATTERNS = {
  ...
  const ZH_STRINGS = {
    menuMinicpmChat: "聊天",
    onboardingWindowTitle: "Open Desk Pet — 首次启动",
    onboardingStepWelcome: "欢迎",
    onboardingStepReady: "就绪",
    onboardingEnvWelcome: "欢迎使用 Open Desk Pet",
    onboardingApiConfigHint: "Open Desk Pet 使用远程 OpenAI 兼容 API。设置完成后，请在 Settings → Open Desk Pet 中配置您的 API。",
    onboardingNext: "下一步",
    ...
    onboardingMoreHint: "配置 API？打开右键菜单的 Settings → Open Desk Pet。",
    ...
    // API Mode settings
    minicpmApiMode: "API 模式",
    minicpmApiModeLocal: "本地 (llama.cpp)",
    minicpmApiModeRemote: "远程 (OpenAI API)",
    minicpmApiBaseUrl: "API 基础地址",
    minicpmApiBaseUrlPlaceholder: "https://api.openai.com/v1",
    minicpmApiKey: "API 密钥",
    minicpmApiKeyPlaceholder: "sk-...",
    minicpmApiModel: "模型名称",
    minicpmApiModelPlaceholder: "gpt-4o-mini",
    minicpmApiTestConnection: "测试连接",
    minicpmApiTestSuccess: "连接成功！",
    minicpmApiTestFailed: "连接失败：{error}",
    minicpmApiConfigRequired: "请配置 API 基础地址和模型名称",
    minicpmRemoteModeNote: "使用远程 API：{model}",
    minicpmLocalModeNote: "使用本地 llama.cpp",
    // Section titles
    minicpmSectionApi: "API 配置",
    minicpmSectionBehavior: "行为",
    minicpmSectionAdvanced: "高级设置",
    // Row labels
    minicpmRowLogs: "日志",
    minicpmOpenLogs: "打开日志",
    minicpmRowNarration: "旁白",
    minicpmRowNarrationHint: "桌宠对 AI 活动进行评论",
    minicpmRowThinking: "默认思考",
    minicpmRowThinkingHint: "默认启用思考模式",
  };
  const ZH_PATTERNS = {
  ...
  const ZH_TW_STRINGS = {
    menuMinicpmChat: "聊天",
    onboardingWindowTitle: "Open Desk Pet — 首次啟動",
    onboardingStepWelcome: "歡迎",
    onboardingStepReady: "就緒",
    onboardingEnvWelcome: "歡迎使用 Open Desk Pet",
    onboardingApiConfigHint: "Open Desk Pet 使用遠端 OpenAI 相容 API。設定完成後，請在 Settings → Open Desk Pet 中配置您的 API。",
    onboardingNext: "下一步",
    ...
    onboardingMoreHint: "配置 API？開啟右鍵選單的 Settings → Open Desk Pet。",
  ...
  const KO_STRINGS = {
    menuMinicpmChat: "채팅",
    onboardingWindowTitle: "Open Desk Pet — 첫 실행",
    onboardingStepWelcome: "환영",
    onboardingStepReady: "준비 완료",
    onboardingEnvWelcome: "Open Desk Pet에 오신 것을 환영합니다",
    onboardingApiConfigHint: "Open Desk Pet은 원격 OpenAI 호환 API를 사용합니다. 설정 완료 후 Settings → Open Desk Pet에서 API를 구성하세요.",
    onboardingNext: "다음",
    ...
    onboardingMoreHint: "API 구성? 우클릭 메뉴의 Settings → Open Desk Pet에서 가능합니다.",
  ...
  // ── JA strings ──
  const JA_STRINGS = {
    menuMinicpmChat: "チャット",
    onboardingWindowTitle: "Open Desk Pet — 初回起動",
    onboardingStepWelcome: "ようこそ",
    onboardingStepReady: "準備完了",
    onboardingEnvWelcome: "Open Desk Petへようこそ",
    onboardingApiConfigHint: "Open Desk Pet はリモート OpenAI 互換 API を使用します。設定完了後、Settings → Open Desk Pet で API を構成してください。",
    onboardingNext: "次へ",
    ...
    onboardingMoreHint: "API 構成？右クリックメニューの Settings → Open Desk Pet から。",
