...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      minicpmHeaderSubtitle: "Remote OpenAI-compatible API",
      ...
      // API Configuration
      minicpmHeaderSubtitle: "Configure your AI API connection",
      ...
      minicpmApiTestFailed: "Connection failed",
      minicpmRowLogs: "Logs",
      ...
      aboutTitle: "About Open Desk Pet",
      aboutSubtitle: "A desktop pet powered by remote OpenAI-compatible APIs.",
      aboutTagline: "A desktop pet powered by remote OpenAI-compatible APIs for your AI coding workflow.",
      ...
      aboutFooter: "Open Desk Pet is open source (remynan). Forked from MiniCPM Desk Pet (OpenBMB).",
      aboutEasterEggToast: "Remote AI, always on your desk.",
    ...
    zh: {
      ...
      minicpmHeaderSubtitle: "远程 OpenAI 兼容 API",
      ...
      // API Configuration
      minicpmHeaderSubtitle: "配置你的 AI API 连接",
      ...
      aboutTitle: "关于 Open Desk Pet",
      aboutSubtitle: "远程 OpenAI 兼容 API 驱动的 AI 桌宠。",
      aboutTagline: "远程 OpenAI 兼容 API 驱动的 AI 编码桌宠伙伴。",
      ...
      aboutFooter: "Open Desk Pet 为开源软件（remynan）。Fork 自 MiniCPM Desk Pet（OpenBMB）。",
      aboutEasterEggToast: "远程 AI，一直在你桌面上。",
    ...
    "zh-TW": {
      ...
      minicpmHeaderSubtitle: "遠端 OpenAI 相容 API",
      ...
      minicpmAdapterCancel: "取消",
      // API Configuration
      minicpmHeaderSubtitle: "設定你的 AI API 連線",
      minicpmSectionApi: "API 設定",
      minicpmSectionBehavior: "行為",
      minicpmSectionAdvanced: "進階設定",
      minicpmApiBaseUrl: "API 基礎網址",
      minicpmApiBaseUrlPlaceholder: "https://api.openai.com/v1",
      minicpmApiKey: "API 金鑰",
      minicpmApiKeyPlaceholder: "sk-...",
      minicpmApiModel: "模型名稱",
      minicpmApiModelPlaceholder: "gpt-4o-mini",
      minicpmApiTestConnection: "測試連線",
      minicpmApiTestSuccess: "連線成功！",
      minicpmApiTestFailed: "連線失敗",
      minicpmRowLogs: "日誌",
      minicpmOpenLogs: "開啟日誌",
      minicpmRowNarration: "旁白",
      minicpmRowNarrationHint: "桌寵對 AI 活動進行評論",
      minicpmRowThinking: "預設思考",
      minicpmRowThinkingHint: "預設啟用思考模式",
      aboutTitle: "關於 Open Desk Pet",
      aboutSubtitle: "遠端 OpenAI 相容 API 驅動的 AI 桌寵。",
      aboutTagline: "遠端 OpenAI 相容 API 驅動的 AI 程式設計桌寵夥伴。",
      aboutVersionLabel: "版本",
      ...
      aboutFooter: "Open Desk Pet 為開源軟體（remynan）。Fork 自 MiniCPM Desk Pet（OpenBMB）。",
      aboutEasterEggToast: "遠端 AI，一直在你桌面上。",
    ...
    ko: {
      ...
      minicpmHeaderSubtitle: "원격 OpenAI 호환 API",
      ...
      // API Configuration
      minicpmHeaderSubtitle: "AI API 연결 설정",
      minicpmSectionApi: "API 설정",
      minicpmSectionBehavior: "동작",
      minicpmSectionAdvanced: "고급 설정",
      minicpmApiBaseUrl: "API 기본 URL",
      minicpmApiBaseUrlPlaceholder: "https://api.openai.com/v1",
      minicpmApiKey: "API 키",
      minicpmApiKeyPlaceholder: "sk-...",
      minicpmApiModel: "모델 이름",
      minicpmApiModelPlaceholder: "gpt-4o-mini",
      minicpmApiTestConnection: "연결 테스트",
      minicpmApiTestSuccess: "연결 성공!",
      minicpmApiTestFailed: "연결 실패",
      minicpmRowLogs: "로그",
      minicpmOpenLogs: "로그 열기",
      minicpmRowNarration: "나레이션",
      minicpmRowNarrationHint: "펫이 AI 활동에 대해 코멘트",
      minicpmRowThinking: "기본 생각",
      minicpmRowThinkingHint: "기본적으로 생각 모드 활성화",
      aboutTitle: "Open Desk Pet 정보",
      aboutSubtitle: "원격 OpenAI 호환 API 기반 AI 데스크톱 펫.",
      aboutTagline: "원격 OpenAI 호환 API로 동작하는 AI 코딩 데스크톱 펫.",
      ...
      aboutFooter: "Open Desk Pet은 오픈 소스(remynan)입니다. MiniCPM Desk Pet(OpenBMB)에서 포크되었습니다.",
      aboutEasterEggToast: "원격 AI, 항상 책상 위에.",
    ...
    ja: {
      ...
      minicpmHeaderSubtitle: "リモート OpenAI 互換 API",
      ...
      // API Configuration
      minicpmHeaderSubtitle: "AI API 接続を設定",
      minicpmSectionApi: "API 設定",
      minicpmSectionBehavior: "動作",
      minicpmSectionAdvanced: "詳細設定",
      minicpmApiBaseUrl: "API ベース URL",
      minicpmApiBaseUrlPlaceholder: "https://api.openai.com/v1",
      minicpmApiKey: "API キー",
      minicpmApiKeyPlaceholder: "sk-...",
      minicpmApiModel: "モデル名",
      minicpmApiModelPlaceholder: "gpt-4o-mini",
      minicpmApiTestConnection: "接続テスト",
      minicpmApiTestSuccess: "接続成功！",
      minicpmApiTestFailed: "接続失敗",
      minicpmRowLogs: "ログ",
      minicpmOpenLogs: "ログを開く",
      minicpmRowNarration: "ナレーション",
      minicpmRowNarrationHint: "ペットが AI 活動をコメント",
      minicpmRowThinking: "デフォルト思考",
      minicpmRowThinkingHint: "デフォルトで思考モードを有効化",
      aboutTitle: "Open Desk Pet について",
      aboutSubtitle: "リモート OpenAI 互換 API 駆動の AI デスクトップペット。",
      aboutTagline: "リモート OpenAI 互換 API で動く AI コーディング用デスクトップペット。",
      ...
      aboutFooter: "Open Desk Pet はオープンソース（remynan）です。MiniCPM Desk Pet（OpenBMB）からフォークされました。",
      aboutEasterEggToast: "リモート AI、いつもデスクの上に。",
